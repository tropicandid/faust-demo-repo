...
export async function generateGlobalStylesheet() {
    ...
    try {
        ...
        if (json.errors) {
            ...
            throw new Error(`There were errors in the GraphQL request: ${errors.join(', ')}`);
        }
        ...
        debugLog(`"faust generateGlobalStylesheet" failed with the following error: `, err);
        errorLog("Unable to update this project's globalStylesheet.css");
        errorLog(`Make sure you have "Enable Public Introspection" checked in WPGraphQL: ${getWpUrl()}/wp-admin/admin.php?page=graphql-settings`);
        process.exit(0);
    }
}
