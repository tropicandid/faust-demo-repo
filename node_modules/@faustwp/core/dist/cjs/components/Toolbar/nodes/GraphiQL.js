...
function GraphiQL({ url = (0, getAdminUrl_js_1.getAdminUrl)('admin.php?page=graphiql-ide'), title = 'GraphiQL IDE', }) {
    return (react_1.default.createElement(index_js_1.ToolbarItem, { href: url },
        react_1.default.createElement("span", { className: "custom-icon", style: styles }),
        title));
}
