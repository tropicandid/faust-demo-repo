 ...
 * @returns
 */
export declare function createSitemapIndex(sitemaps: SitemapSchemaSitemapElement[]): Response;
/**
 ...
 * @returns {Response}
 */
export declare function createSitemap(urls: SitemapSchemaUrlElement[]): Response;
