 ...
 */
function getTypographyStyles(theme, block) {
    const { attributes } = block;
    const styles = {};
    if (attributes === null || attributes === void 0 ? void 0 : attributes.fontFamily) {
    ...
    if (attributes === null || attributes === void 0 ? void 0 : attributes.fontSize) {
        // eslint-disable-next-line @typescript-eslint/restrict-template-expressions
        styles.fontSize = `var(--wp--preset--font-size--${attributes.fontSize})`;
    }
    return styles;
}
exports.default = getTypographyStyles;
