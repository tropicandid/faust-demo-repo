...
const BlockToolbar = _ref => {
  ...
  return createElement("div", {
    className: classes
  }, !isMultiToolbar && !displayHeaderToolbar && !isContentLocked && createElement(BlockParentSelector, null), createElement("div", _extends({
    ref: nodeRef
  }, showMoversGestures), (shouldShowVisualToolbar || isMultiToolbar) && !isContentLocked && createElement(ToolbarGroup, {
    ...
    clientIds: blockClientIds
  }), !isContentLocked && createElement(BlockSettingsMenu, {
    clientIds: blockClientIds
  }));
};
/**
