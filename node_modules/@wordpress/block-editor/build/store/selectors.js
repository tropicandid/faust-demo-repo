...
const getBlocksByClientId = (0, _rememo.default)((state, clientIds) => (0, _lodash.map)(Array.isArray(clientIds) ? clientIds : [clientIds], clientId => getBlock(state, clientId)), (state, clientIds) => (0, _lodash.map)(Array.isArray(clientIds) ? clientIds : [clientIds], clientId => state.blocks.tree[clientId]));
/**
...
const __experimentalGetAllowedPatterns = (0, _rememo.default)(function (state) {
  ...
  const patternsAllowed = (0, _lodash.filter)(availableParsedPatterns, _ref11 => {
    let {
      blocks
    } = _ref11;
