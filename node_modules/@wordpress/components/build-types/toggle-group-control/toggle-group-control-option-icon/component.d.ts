...
export declare const ToggleGroupControlOptionIcon: import("react").ForwardRefExoticComponent<Pick<import("../types").ToggleGroupControlOptionBaseProps, "value"> & {
    icon: JSX.Element;
    label: string;
} & Omit<Pick<import("react").DetailedHTMLProps<import("react").ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, "key" | keyof import("react").ButtonHTMLAttributes<HTMLButtonElement>>, "children" | "value" | "icon" | "label" | "as"> & import("react").RefAttributes<any>>;
