...
export default function QueryInspectorControls(_ref) {
  ...
  return createElement(Fragment, null, showSettingsPanel && createElement(InspectorControls, null, createElement(PanelBody, {
  ...
  }))), !inherit && createElement(InspectorControls, null, createElement(ToolsPanel, {
  ...
  }, !!(taxonomies !== null && taxonomies !== void 0 && taxonomies.length) && isControlAllowed(allowedControls, 'taxQuery') && createElement(ToolsPanelItem, {
    label: __('Taxonomies'),
    ...
    onChange: setQuery,
    query: query
  })), isControlAllowed(allowedControls, 'author') && createElement(ToolsPanelItem, {
    hasValue: () => !!authorIds,
    label: __('Authors'),
    onDeselect: () => setQuery({
      author: ''
    ...
    value: authorIds,
    onChange: setQuery
  })), isControlAllowed(allowedControls, 'search') && createElement(ToolsPanelItem, {
  ...
  })), isPostTypeHierarchical && isControlAllowed(allowedControls, 'parents') && createElement(ToolsPanelItem, {
