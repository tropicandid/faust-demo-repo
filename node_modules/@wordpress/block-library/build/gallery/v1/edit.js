...
function GalleryEdit(props) {
  ...
  function getImagesSizeOptions() {
    ...
    return (0, _lodash.map)((0, _lodash.filter)(imageSizes, _ref2 => {
      let {
        slug
      } = _ref2;
  ...
  (0, _element.useEffect)(() => {
    if (_element.Platform.OS === 'web' && images && images.length > 0 && images.every(_ref4 => {
      let {
        url
      } = _ref4;
      return (0, _blob.isBlobURL)(url);
    })) {
      const filesList = (0, _lodash.map)(images, _ref5 => {
        let {
          url
        } = _ref5;
