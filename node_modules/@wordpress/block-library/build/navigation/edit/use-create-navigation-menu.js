...
exports.CREATE_NAVIGATION_MENU_SUCCESS = CREATE_NAVIGATION_MENU_SUCCESS;
const CREATE_NAVIGATION_MENU_ERROR = 'error';
exports.CREATE_NAVIGATION_MENU_ERROR = CREATE_NAVIGATION_MENU_ERROR;
const CREATE_NAVIGATION_MENU_PENDING = 'pending';
exports.CREATE_NAVIGATION_MENU_PENDING = CREATE_NAVIGATION_MENU_PENDING;
const CREATE_NAVIGATION_MENU_IDLE = 'idle';
exports.CREATE_NAVIGATION_MENU_IDLE = CREATE_NAVIGATION_MENU_IDLE;
...
function useCreateNavigationMenu(clientId) {
  ...
  const create = (0, _element.useCallback)(async function () {
