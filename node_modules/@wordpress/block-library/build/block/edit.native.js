...
function ReusableBlockEdit(_ref) {
  ...
  const infoTextStyle = (0, _compose.usePreferredColorSchemeStyle)(_editor.default.infoText, _editor.default.infoTextDark);
  const infoTitleStyle = (0, _compose.usePreferredColorSchemeStyle)(_editor.default.infoTitle, _editor.default.infoTitleDark);
  const infoSheetIconStyle = (0, _compose.usePreferredColorSchemeStyle)(_editor.default.infoSheetIcon, _editor.default.infoSheetIconDark);
  const infoDescriptionStyle = (0, _compose.usePreferredColorSchemeStyle)(_editor.default.infoDescription, _editor.default.infoDescriptionDark);
  const actionButtonStyle = (0, _compose.usePreferredColorSchemeStyle)(_editor.default.actionButton, _editor.default.actionButtonDark);
  const spinnerStyle = (0, _compose.usePreferredColorSchemeStyle)(_editor.default.spinner, _editor.default.spinnerDark);
  const {
    hasResolved,
    isEditing,
    isMissing
  ...
  const onConvertToRegularBlocks = (0, _element.useCallback)(() => {
    ...
    (0, _i18n.__)('%s converted to regular blocks'), title));
  ...
  function renderSheet() {
    const infoTitle = _reactNative.Platform.OS === 'android' ? (0, _i18n.__)('Editing reusable blocks is not yet supported on WordPress for Android') : (0, _i18n.__)('Editing reusable blocks is not yet supported on WordPress for iOS');
    ...
    }, (0, _i18n.__)('Alternatively, you can detach and edit these blocks separately by tapping “Convert to regular blocks”.')), (0, _element.createElement)(_components.TextControl, {
  ...
  let element = (0, _element.createElement)(_blockEditor.InnerBlocks, {
    value: blocks,
    onChange: onChange,
    onInput: onInput
  });
